...
- **Command:**
  ```bash
  curl -s -H "x-apikey: $VT_KEY" "https://www.virontotal.com/api/v3/ip_addresses/1.2.3.4" \
  ...
  curl -s -H "x-apikey: $VT_KEY" "https://www.virontotal.com/api/v3/ip_addresses/1.2.3.4/resolutions?limit=40" \
