...
- **Mandiant attribution.** Mandiant attributed the Colonial Pipeline intrusion to a DarkSide affiliate with overlapping TTPs to a tracked cluster (later designated as UNC2452/Nobelium-adjacent for unrelated intrusions, but with the Colonial-specific affiliate tracked separately). The attribution rested on infrastructure overlap and TTP consistency.
